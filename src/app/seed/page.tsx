...
const locs = [
  ...
  { id: 'loc-nrw',     name: 'Aachen',                city: 'Aachen',              country: 'Deutschland', color: '#8B5CF6' },
  { id: 'loc-mgl',     name: 'Mönchengladbach',      city: 'Mönchengladbach',     country: 'Deutschland', color: '#F59E0B' },
  { id: 'loc-dus',     name: 'Düsseldorf',            city: 'Düsseldorf',          country: 'Deutschland', color: '#EF4444' },
  { id: 'loc-neuss',   name: 'Neuss',                 city: 'Neuss',               country: 'Deutschland', color: '#06B6D4' },
  { id: 'loc-do',      name: 'Dortmund',              city: 'Dortmund',            country: 'Deutschland', color: '#84CC16' },
  { id: 'loc-mh',      name: 'Mülheim',               city: 'Mülheim an der Ruhr', country: 'Deutschland', color: '#F97316' },
...
const allProperties = [
  ...
  p('prop-052','BPS13 WE1',  'BPS13 · WE 1', 'Aachen', 'loc-nrw', 6),
  p('prop-053','BPS13 WE2',  'BPS13 · WE 2', 'Aachen', 'loc-nrw', 6),
  p('prop-054','BPS15 WE1',  'BPS15 · WE 1', 'Aachen', 'loc-nrw', 6),
  p('prop-055','BPS15 WE2',  'BPS15 · WE 2', 'Aachen', 'loc-nrw', 6),
  p('prop-056','BPS15 WE3',  'BPS15 · WE 3', 'Aachen', 'loc-nrw', 6),
  p('prop-057','BPS15 WE4',  'BPS15 · WE 4', 'Aachen', 'loc-nrw', 6),
  p('prop-058','BPS15 WE6',  'BPS15 · WE 6', 'Aachen', 'loc-nrw', 6),
  // Mönchengladbach
